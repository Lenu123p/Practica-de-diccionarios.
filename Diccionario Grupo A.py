...
def buscar_contacto(contactos):
    ...
    if nombre in contactos:
        print(f"Se encontro el contacto número de teléfono de {nombre} es: {contactos[nombre]}")
    else:
        print(f"No se encontró el contacto de {nombre}.")
...
def main():
    while True:
        ...
        if opcion == "1":
            ...
            print("Gracias por usar nuestro servico. Adios!")
            break
        else:
